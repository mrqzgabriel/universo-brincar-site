# =============================================================================
# Site institucional do Hotel Infantil Universo Brincar
# Imagem única: nginx servindo arquivos estáticos.
# Método de construção no EasyPanel: Dockerfile. Porta do container: 80.
# =============================================================================
FROM nginx:1.27-alpine

LABEL org.opencontainers.image.title="Site Universo Brincar" \
      org.opencontainers.image.description="Site institucional do Hotel Infantil Universo Brincar" \
      org.opencontainers.image.vendor="Hotel Infantil Universo Brincar LTDA"
